...
# Load dataset
df = pd.read_csv(r"c:\Data Analysis Project\dmart project\Dmart_Sales_Analysis_Final_4200plus.csv")
...
df.to_csv(
    r"C:\Users\ashok\Downloads\Dmart_Sales_Cleaned.csv",
    index=False
)
...
file_path = r"C:\Users\ashok\Downloads\Dmart_Sales_Cleaned.csv"
